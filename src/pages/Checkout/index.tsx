...
import barCode from '../../assests/image/barcode1.png'
import creditCard from '../../assests/image/credit_card1.png'
  ...
  const form = useFormik({
    ...
    validationSchema: Yup.object({
        ...
        email: Yup.string()
          ...
          .required('O campo é obrigatório'),
        cpf: Yup.string()
        .min(14, 'O campo precisa ter 14 caracteries')
        .max(14, 'O campo precisa ter 14 caracteries')
        .required('O campo é obrigatório'),
        ...
        <Card title="Muito Obrigado">
          <>
            ...
            <p className="margin-top">
              ...
              Caso tenha  dúvida ou necessite de mais informações, por favor, entre em contato conosco através dos nossos canais de atendimento ao cliente.
            </p>
            <p className="margin-top">
              Agradecemos poralguma escolher a EPLAY e esperamos que desfrute do seu jogo!
            </p>
          </>
        </Card>
      ) : (
        <form onSubmit={form.handleSubmit} >
          ...
          <Card title="Pagamento">
            <>
              ...
              type="button"
              >
                  <img src={creditCard} alt="Cartaõ de Crédito" />
                Cartaõ de Crédito
              </S.TabButton>
              ...
              {payWithCard ? (
                ...
                <p>Ao optar por essa forma de pagamento, é importante lembrar que a confirmação pode levar
                  até 3 dias úteis, devido aos prazos estabelecidos pelas instituições financeiras. Portanto, a
                  liberação do código de ativação do jogo adquirido ocorrerá somente após a aprovação do
                  pagamento do boleto.</p>
              )}
              </div>
            </>
          </Card>
